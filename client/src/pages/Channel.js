      ...
      <div className="header-tabs">
        ...
        <div className="tabs">
          <ul className="secondary">
            <li style={tab === 'VIDEOS' ? activeTabStyle : {}} onClick={() => setTab('VIDEOS')}>
              Videos
            </li>
            <li style={tab === 'CHANNELS' ? activeTabStyle : {}} onClick={() => setTab('CHANNELS')}>
              Channels
            </li>
            <li style={tab === 'ABOUT' ? activeTabStyle : {}} onClick={() => setTab('ABOUT')}>
              About
            </li>
          </ul>
        </div>
