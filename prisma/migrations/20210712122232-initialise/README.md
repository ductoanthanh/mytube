# Migration `20210712122232-initialise`

This migration has been generated by Duc Toan Thanh at 7/12/2021, 3:22:32 PM.
...
CREATE TABLE "User" (
    ...
    "email" TEXT NOT NULL,
    "avatar" TEXT NOT NULL DEFAULT E'https://res.cloudinary.com/dcdph91rz/image/upload/v1626092075/default-avatar.png',
    "cover" TEXT NOT NULL DEFAULT E'https://res.cloudinary.com/dcdph91rz/image/upload/v1626092086/default-cover-banner.png',
...
+  username     String
+  email        String         @unique
+  avatar       String         @default("https://res.cloudinary.com/dcdph91rz/image/upload/v1626092075/default-avatar.png")
+  cover        String         @default("https://res.cloudinary.com/dcdph91rz/image/upload/v1626092086/default-cover-banner.png")
